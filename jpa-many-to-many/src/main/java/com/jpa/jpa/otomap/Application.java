...
import com.jpa.jpa.otomap.entity.*;
...
public class Application {
	...
	/**
	 * We want to delete/add the reviews along with the course
	 * @param appDao
	 * @return
	 */
	@Bean
...
//			addMoreCoursesForStudent(appDao);
	...
	private void addMoreCoursesForStudent(AppDao appDao) {
		int studentId = 2;
		Student tempStudent = appDao.findCoursesAndStudentsByStudentId(studentId);
	...
	private void createCourseAndStudents(AppDao appDao) {
		...
		System.out.println("assocaited students: " + tempCourse.getStudents());

		//CascadeType persist ensures that students are also saved
	...
	private void deleteCourseAndReviews(AppDaoImpl appDao) {
		...
		appDao.deleteCourseById(theId);
		//BOTH COURSES AND THERE CORRESPONDING REVIEWS ARE DELETED
		System.out.println("Done!!");
	}
	...
	private void retrieveCourseAndReviews(AppDaoImpl appDao) {
		...
		System.out.println("The retreived Course is: " + tempCourse);

		System.out.println("The retrieved Courses are: " + tempCourse.getReviews());
	...
	private void createCourseAndReviews(AppDaoImpl appDao) {
		...
		//save the course and leverage the facility of saving the reviews
		System.out.println("Saving the course: " + tempCourse);
		appDao.save(tempCourse);
		System.out.println("Done!!");
	}
